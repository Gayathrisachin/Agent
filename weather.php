...
$sql="SELECT city FROM agent WHERE Agent_Code='$acode' AND Agent_Name='$name'";
$Cname = mysqli_query($con,$sql);
$row1=$Cname->fetch_assoc();
?>
...
<body>
  ...
  <header class="header">
    <div class="search">
    <form>
      <input type="text" placeholder="Enter City Name" Value="<?php echo $row['city'];?>" id="search-txt">
